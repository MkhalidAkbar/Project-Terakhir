<div class="page-inner">
          <div class="page-header">
            <h4 class="page-title">Mata Pelajaran / Judul Absen</h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                              <h4 id="exampleModalLabel" class="modal-title">Edit Mapel/judul</h4>
...
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal" class="modal fade" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
           <div class="modal-header">
                              <h4 id="exampleModalLabel" class="modal-title">Tambah Mapel/judul</h4>
                              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                            </div>
            <div class="modal-body">
                <form action="" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label>Nama mapel/judul</label>
                        <input name="mapel" type="text" placeholder="Nama mapel/judul absen" class="form-control">
                    </div>
