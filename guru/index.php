							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									...
									<li>
										...
										<a class="dropdown-item" href="?page=akun&id=<?=$data['id_guru'] ?>" >Akun Saya</a>
										<div class="dropdown-divider"></div>
					...
					<div class="user">
						...
						<div class="info">
							...
							<div class="collapse in" id="collapseExample">
								<ul class="nav">
									<li>
										<a href="?page=akun&id=<?=$data['id_guru'] ?>">
						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=absen&pelajaran=<?=$dm['id_mengajar'] ?>&bulan=<?=$bulan ?>&kelas=<?=$dm['id_mkelas'] ?> ">
											<span class="sub-item">KELAS (<?=strtoupper($dm['nama_kelas']); ?> - <b><?=strtoupper($dm['mapel']) ?></b>)</span>
										</a>
									</li>
								<?php } ?>
								</ul>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Siswa 
					</div>				
				</div>
			</footer>
		</div>
