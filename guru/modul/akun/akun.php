							...
							<div class="card">
								...
								<table cellpadding="3" style="font-weight: bold;">
									<tr>
										<td>NIP </td>
										<td>:</td>
										<td><input type="number" class="form-control" name="nip" value="<?=$d['nip'] ?>" readonly></td>
									</tr>
									<tr>
										<td>Nama Guru </td>
										<td>:</td>
										<td><input type="text" class="form-control" name="nama" value="<?=$d['nama_guru'] ?>" readonly></td>
									</tr>
									<tr>
										<td>Email </td>
										<td>:</td>
										<td><input type="email" class="form-control" name="email" value="<?=$d['email'] ?>" readonly></td>
									</tr>
									<tr>
										<td>Alamat </td>
										<td>:</td>
										<td><textarea type="text" class="form-control" name="alamat" readonly><?=$d['alamat'] ?></textarea></td>
									</tr>
									<tr>
										<td>No. HP </td>
										<td>:</td>
										<td><input type="text" class="form-control" name="nohp" value="<?=$d['nohp'] ?>" readonly></td>
									</tr>
								</table>
								<br>
								<p>Jika ingin mengubah data profile akun bisa hubungi admin !</p>
								<br>
