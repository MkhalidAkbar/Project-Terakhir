...
<head>
	...
	<title>Wali kelas | Aplikasi Absensi</title>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="green">
				...
				<a href="dashboard.php" class="logo">
					<img src="../assets/img/muhammadiyah.png" alt="navbar brand" class="navbar-brand" width="40">
					<b class="text-white">Muhammadiyah 7</b>
				</a>
				<button class="navbar-toggler sidenav-toggler lg-auto" type="button" data-toggle="collapse" data-target="collapse" aria-expanded="false" aria-label="Toggle navigation">
					...
					<div class="user">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									<?=$data['nama_lengkap'] ?>
									<span class="user-level">Wali Kelas</span>
						...
						<li class="nav-section">
							...
							<h4 class="text-section">Main Utama</h4>
								...
								<?php 
									...
									INNER JOIN tb_walikelas ON tb_mengajar.id_walikelas=tb_walikelas.id_walikelas
									WHERE tb_walikelas.id_walikelas='$data[id_walikelas]'
									GROUP BY tb_walikelas.id_mkelas
									 ");
									
									foreach ($kelas as $g) {?>

						<li class="nav-item">
							<a href="?page=rekap&walikelas=<?=$g['id_walikelas']?>&guru=<?=$g['id_guru']?>">
		...
		<div class="main-panel">
			<div class="content">
				...
				if ($page=='master') {
					// kelas
					if ($act=='data_umum') {
					include 'modul/master/data_umum/data_umum.php';
					}elseif ($act=='delkelas') {
					include 'modul/master/data_umum/del.php';
					// semster
					}elseif ($act=='semester') {
          ...
          if ($act=='') {
			...
			if ($act=='') {
				include 'modul/rekap/absen_kelas.php';
			}				
		}elseif ($page=='jadwal') {
			if ($act=='') {
							...
							<div class="modal-dialog modal-sm" role="document">
								<div class="modal-content">
									...
									if (isset($_POST['changePassword'])) {
										...
										if ($passLama == $pass) {
											$set = mysqli_query($con,"UPDATE tb_walikelas SET password='$newPass' WHERE id_walikelas='$data[id_walikelas]' ");
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<div class="form-group">
      		...
      		<input type="hidden" name="id" value="<?=$data['id_walikelas'] ?>">       		
      	</div>   
      	<div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button name="updateProfile" type="submit" class="btn btn-primary">Simpan</button>
      	...
      	<?php 
					...
					$ganti = mysqli_query($con,"UPDATE tb_walikelas SET foto='$gambar' WHERE id_walikelas='$_POST[id]' ");
					}  	

					      $sqlEdit = mysqli_query($con,"UPDATE tb_walikelas SET nama_lengkap='$_POST[nama]',username='$_POST[username]' WHERE id_walikelas='$_POST[id]' ") or die(mysqli_error($konek));
